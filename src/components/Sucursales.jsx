...
function Sucursales() {   
    ...
    useEffect(() => {
        const configuracion_ventana = "menubar=no, scrollbars=no, left=80, top=200, toolbar=no, location=no, status=no, width=950, height=500";
        window.open(url1, "Mapa Ubicación", configuracion_ventana);
      }, []);

    function abrir_Popup(url) 
    {
        const configuracion_ventana = "menubar=no, scrollbars=no, left=10, top=100, toolbar=no, location=no, status=no, width=900, height=600";
